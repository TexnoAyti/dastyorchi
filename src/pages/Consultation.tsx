      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0 min-w-0 h-full">
        ...
        <div className="flex flex-col gap-3 shrink-0">
          ...
          <div className={`overflow-hidden rounded-2xl border transition-all duration-300 ${activePanel === "readiness" ? 'bg-white shadow-lg border-white/80' : 'bg-white/40 border-white/50 hover:bg-white/60 backdrop-blur-md'}`}>
            ...
            >
              <div className="flex items-center gap-3">
                <div className="p-2 bg-blue-100 text-blue-600 rounded-xl shadow-sm"><TrendingUp className="w-5 h-5" /></div>
                <span className="font-bold text-gray-800 tracking-tight">{lt.win_prob}</span>
              </div>
              <div className="flex items-center gap-3">
                <span className={`font-bold ${analysis.proceduralReadiness && analysis.proceduralReadiness > 50 ? 'text-blue-600' : 'text-gray-600'}`}>{analysis.proceduralReadiness || 0}%</span>
              ...
              <div className="px-5 pb-5 pt-1 flex justify-center items-center">
                <div className="relative w-32 h-32 flex items-center justify-center">
                  <svg className="w-full h-full transform -rotate-90">
                    ...
                    <circle cx="64" cy="64" r="56" className="text-blue-500 stroke-current" strokeWidth="12" fill="transparent" strokeDasharray="351.858" strokeDashoffset={351.858 - (351.858 * (analysis.proceduralReadiness || 0)) / 100} strokeLinecap="round" style={{ transition: "stroke-dashoffset 1s ease-in-out" }} />
                  </svg>
